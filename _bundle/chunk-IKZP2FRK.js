...
import{a as e}from"./chunk-HTIJ5P5S.js";var s="gaussianSplatting",r=`fn getDataUV(index: f32,dataTextureSize: vec2f)->vec2<f32> {let y: f32=floor(index/dataTextureSize.x);let x: f32=index-y*dataTextureSize.x;return vec2f((x+0.5),(y+0.5));}
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=r);var t="gaussianSplattingVertexShader",a=`#include<sceneUboDeclaration>
...
`;e.ShadersStoreWGSL[t]||(e.ShadersStoreWGSL[t]=a);var S={name:t,shader:a};export{S as a};
