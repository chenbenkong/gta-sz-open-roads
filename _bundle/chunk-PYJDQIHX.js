...
import{a as e}from"./chunk-HTIJ5P5S.js";var r="iblDominantDirectionPixelShader",i=`#include<helperFunctions>
...
lightDir/=vec3f(f32(NUM_SAMPLES));fragmentOutputs.color=vec4f(lightDir,1.0);}`;e.ShadersStoreWGSL[r]||(e.ShadersStoreWGSL[r]=i);var m={name:r,shader:i};export{m as a};
