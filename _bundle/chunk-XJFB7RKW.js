...
import{a as r}from"./chunk-HTIJ5P5S.js";var e="fluidRenderingStandardBlurPixelShader",o=`uniform sampler2D textureSampler;uniform int filterSize;uniform vec2 blurDir;varying vec2 vUV;void main(void) {vec4 s=textureLod(textureSampler,vUV,0.);if (s.r==0.) {glFragColor=vec4(0.,0.,0.,1.);return;}
...
`;r.ShadersStore[e]||(r.ShadersStore[e]=o);var i={name:e,shader:o};export{i as a};
