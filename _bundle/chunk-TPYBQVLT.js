...
import{a as e}from"./chunk-HTIJ5P5S.js";var r="iblVoxelGrid3dDebugPixelShader",a=`varying vUV: vec2f;var voxelTextureSampler: sampler;var voxelTexture: texture_3d<f32>;var voxelSlabTextureSampler: sampler;var voxelSlabTexture: texture_2d<f32>;var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;uniform sizeParams: vec4f;
...
fragmentOutputs.color=vec4f(mix(background.rgb,voxelSlab.rgb,voxelSlab.a)+voxel,1.0);}}`;e.ShadersStoreWGSL[r]||(e.ShadersStoreWGSL[r]=a);var s={name:r,shader:a};export{s as a};
