...
import{a as e}from"./chunk-HTIJ5P5S.js";var a="bayerDitherFunctions",n=`fn bayerDither2(_P: vec2f)->f32 {return ((2.0*_P.y+_P.x+1.0)%(4.0));}
...
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=n);var t="shadowMapFragmentExtraDeclaration",f=`#if SM_FLOAT==0
...
varying zSM: f32;
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=f);var r="shadowMapPixelShader",i=`#include<shadowMapFragmentExtraDeclaration>
#ifdef ALPHATEXTURE
...
}`;e.ShadersStoreWGSL[r]||(e.ShadersStoreWGSL[r]=i);var M={name:r,shader:i};export{M as a};
