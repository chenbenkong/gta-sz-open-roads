...
import{a as i}from"./chunk-HTIJ5P5S.js";var e="iblDominantDirectionPixelShader",r=`precision highp sampler2D;precision highp samplerCube;
...
lightDir/=float(NUM_SAMPLES);gl_FragColor=vec4(lightDir,1.0);}`;i.ShadersStore[e]||(i.ShadersStore[e]=r);var a={name:e,shader:r};export{a};
