...
import{a as e}from"./chunk-HTIJ5P5S.js";var a="bayerDitherFunctions",t=`float bayerDither2(vec2 _P) {return mod(2.0*_P.y+_P.x+1.0,4.0);}
...
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=t);var o="shadowMapFragmentExtraDeclaration",n=`#if SM_FLOAT==0
...
varying float zSM;
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=n);var r="shadowMapPixelShader",i=`#include<shadowMapFragmentExtraDeclaration>
#ifdef ALPHATEXTURE
