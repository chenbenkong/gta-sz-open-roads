...
import{a as e}from"./chunk-HTIJ5P5S.js";var t="pbrFragmentExtraDeclaration",g=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=g);var o="subSurfaceScatteringFunctions",u=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=u);var i="pbrHelperFunctions",E=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=E);var r="pbrDirectLightingSetupFunctions",D=`struct preLightingInfo
...
result.areaLightDiffuse=data.Diffuse;result.LdotV=0.;result.roughness=0.;result.diffuseRoughness=0.;result.surfaceAlbedo=vec3(0.);return result;}
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=D);var a="pbrDirectLightingFalloffFunctions",h=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=h);var n="pbrDirectLightingFunctions",L=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=L);var l="pbrIBLFunctions",A=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=A);var f="pbrBlockNormalGeometric",p=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=p);var c="pbrBlockImageProcessing",S=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=S);var s="pbrBlockPrePass",C=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=C);var d="pbrDebug",m=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=m);
