...
import{a as e}from"./chunk-HTIJ5P5S.js";var r="mrtFragmentDeclaration",n=`#if defined(WEBGL2) || defined(WEBGPU) || defined(NATIVE)
layout(location=0) out vec4 glFragData[{X}];
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=n);var i="geometryPixelShader",f=`#extension GL_EXT_draw_buffers : require
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=f);var u={name:i,shader:f};export{u as a};
