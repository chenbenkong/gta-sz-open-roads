...
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=T);var n="openpbrFragmentSamplersDeclaration",A=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=A);var r="openpbrNormalMapFragmentMainFunctions",F=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=F);var t="openpbrNormalMapFragmentFunctions",L=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=L);var a="openpbrDielectricReflectance",b=`struct ReflectanceParams
...
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=b);var s="openpbrConductorReflectance",O=`#define pbr_inline
...
#endif
outParams.F0=1.0;outParams.F90=1.0;return outParams;}`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=O);var f="openpbrAmbientOcclusionFunctions",C=`float compute_specular_occlusion(const float n_dot_v,const float metallic,const float ambient_occlusion,const float roughness)
...
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=C);var l="openpbrGeometryInfo",D=`struct geometryInfoOutParams
...
{geometryInfoOutParams geoInfo=geometryInfo(normalW,viewDirectionW,roughness,geometricNormalW);geometryInfoAnisoOutParams outParams;outParams.NdotV=geoInfo.NdotV;outParams.NdotVUnclamped=geoInfo.NdotVUnclamped;outParams.environmentBrdf=geoInfo.environmentBrdf;outParams.horizonOcclusion=geoInfo.horizonOcclusion;outParams.anisotropy=vAnisotropy.b;vec3 anisotropyDirection=vec3(vAnisotropy.xy,0.);mat3 anisoTBN=mat3(normalize(TBN[0]),normalize(TBN[1]),normalize(TBN[2]));outParams.anisotropicTangent=normalize(anisoTBN*anisotropyDirection);outParams.anisotropicBitangent=normalize(cross(anisoTBN[2],outParams.anisotropicTangent));outParams.TBN=TBN;return outParams;}`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=D);var c="openpbrIblFunctions",M=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=M);var d="openpbrNormalMapFragment",G=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=G);var m="openpbrBlockNormalFinal",x=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=x);var _="openpbrBaseLayerData",P=`vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);float geometry_thickness=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=z);var p="openpbrCoatLayerData",y=`float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=y);var g="openpbrThinFilmLayerData",U=`#ifdef THIN_FILM
...
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=U);var I="openpbrFuzzLayerData",W=`float fuzz_weight=0.0;vec3 fuzz_color=vec3(1.0);float fuzz_roughness=0.0;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=W);var E="openpbrAmbientOcclusionData",X=`vec3 ambient_occlusion=vec3(1.0);float specular_ambient_occlusion=1.0;float coat_specular_ambient_occlusion=1.0;
#ifdef AMBIENT_OCCLUSION
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=X);var v="openpbrBackgroundTransmission",B=`vec4 slab_translucent_background=vec4(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=B);var R="openpbrEnvironmentLighting",H=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=H);var h="openpbrDirectLightingInit",V=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=V);var S="openpbrDirectLighting",w=`#ifdef LIGHT{X}
...
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=w);var o="openpbrPixelShader",N=`#define OPENPBR_FRAGMENT_SHADER
...
`;e.ShadersStore[o]||(e.ShadersStore[o]=N);var Wo={name:o,shader:N};export{Wo as a};
