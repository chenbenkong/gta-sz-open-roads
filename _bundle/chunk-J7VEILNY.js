...
import{a as e}from"./chunk-HTIJ5P5S.js";var r="iblIcdfPixelShader",t=`#include<helperFunctions>
varying vUV: vec2f;
...
.r;var pixelLuminance: f32=fetchLuminance(input.vUV);outputColor.z=pixelLuminance/(2.0*PI*normalization);fragmentOutputs.color=vec4( outputColor,1.0);}`;e.ShadersStoreWGSL[r]||(e.ShadersStoreWGSL[r]=t);var c={name:r,shader:t};export{c as a};
